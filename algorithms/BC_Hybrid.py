    ...
    def train(self) -> None:
        ...
        with tqdm(total=self.expert_episode_used,
            ...
            while sampled_idx < self.expert_episode_used:
                ...
                Xc = np.vstack(
                    (info["Expert_Policy"]["PF"], info["Expert_Policy"]["QF"]))
        ...
        Xd, Yd, Xc, Yc = self.buffer.sample(batch_size=self.expert_sample_used,
                                            shuffle=True)
...
if __name__ == "__main__":
    ...
    # BC learning parameters
    parser.add_argument('--lr', type=float, default=1.0e-3)
    parser.add_argument('--batch_size', type=int, default=16)
    parser.add_argument('--used_exp_episodes', type=int, default=200)
    parser.add_argument('--used_exp_samples', type=int, default=100)
